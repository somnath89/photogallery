...
import {addStudent,deleteStudent,updateStudent} from './studentActions';
...
class Home extends Component {
  ...
  addNewStudent()
  {
this.props.addStudent({id:Math.max(...this.props.studentList.map(function(o){return o.id})) + 1,name:'Lara Thomas',grade:1,school:'my own school'});
  }
